...
object_draft_schematic_clothing_clothing_ith_hat_formal_02 = object_draft_schematic_clothing_shared_clothing_ith_hat_formal_02:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Ithorian Religious Cap",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_ith_hat_formal_02, "object/draft_schematic/clothing/clothing_ith_hat_formal_02.iff")
