...
object_draft_schematic_clothing_clothing_wke_shirt_s02 = object_draft_schematic_clothing_shared_clothing_wke_shirt_s02:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Weighted Wookiee Pullover",
   ...
   targetTemplate = "object/tangible/wearables/wookiee/wke_shirt_s02.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_wke_shirt_s02, "object/draft_schematic/clothing/clothing_wke_shirt_s02.iff")
