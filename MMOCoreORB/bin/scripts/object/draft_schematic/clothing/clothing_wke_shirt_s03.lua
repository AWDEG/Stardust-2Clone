...
object_draft_schematic_clothing_clothing_wke_shirt_s03 = object_draft_schematic_clothing_shared_clothing_wke_shirt_s03:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Wookiee Battle Padding",
   ...
   targetTemplate = "object/tangible/wearables/wookiee/wke_shirt_s03.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_wke_shirt_s03, "object/draft_schematic/clothing/clothing_wke_shirt_s03.iff")
