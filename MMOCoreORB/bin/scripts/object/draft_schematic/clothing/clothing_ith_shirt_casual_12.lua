...
object_draft_schematic_clothing_clothing_ith_shirt_casual_12 = object_draft_schematic_clothing_shared_clothing_ith_shirt_casual_12:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Ithorian Tight Fit Shirt",
   ...
   ingredientTitleNames = {"body", "stitching", "binding_and_hardware"},
   ...
   targetTemplate = "object/tangible/wearables/ithorian/ith_shirt_s12.iff",
