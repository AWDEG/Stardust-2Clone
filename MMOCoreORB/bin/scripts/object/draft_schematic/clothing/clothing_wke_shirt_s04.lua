...
object_draft_schematic_clothing_clothing_wke_shirt_s04 = object_draft_schematic_clothing_shared_clothing_wke_shirt_s04:new {
   ...
   targetTemplate = "object/tangible/wearables/wookiee/wke_shirt_s04.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_wke_shirt_s04, "object/draft_schematic/clothing/clothing_wke_shirt_s04.iff")
