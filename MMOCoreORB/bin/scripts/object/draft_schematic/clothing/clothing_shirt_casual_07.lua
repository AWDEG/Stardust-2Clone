...
object_draft_schematic_clothing_clothing_shirt_casual_07 = object_draft_schematic_clothing_shared_clothing_shirt_casual_07:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Casual Shirt",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_shirt_casual_07, "object/draft_schematic/clothing/clothing_shirt_casual_07.iff")
